...
% from https://raw.githubusercontent.com/Psychtoolbox-3/Psychtoolbox-3/beta/Psychtoolbox/PsychDemos/ECVP2013/HelloShapesDemo.m
...
r3=OffsetRect(r1, 300,300);
r4=OffsetRect(r1, 400,400);
...
% And a square:
r9=OffsetRect([0 0 100 100], 500,500);
Screen('FillRect', win, [0.75, 0.75, 0.75], r9);

% And some circle:
r7=OffsetRect([0 0 100 100], 500,500);
Screen('FillOval', win, [0.0, 0.5, 0.8], r7);
