...
function [pacmanOpts, npc_servings, hide_time_table] = pacmanGetWaitTable(pacmanOpts, Exp_Type)
    ...
    % Store values into pacmanOpts
    pacmanOpts.npcTimeTableSpecs = time_table_specs;
    pacmanOpts.npcTimeTableOriginal = npc_table_original;
    pacmanOpts.npcTimeTableRandomized = npc_table_rand;
end
